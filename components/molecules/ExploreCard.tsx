  ...
  return (
    ...
    >
      <GlassCard className='flex h-full w-full gap-2 p-4 sm:flex-col sm:p-6'>
        <div className='text-muted-foreground my-auto flex h-fit w-fit items-center justify-center rounded-sm bg-white/20 p-3 transition-colors duration-300 group-hover:bg-linear-to-br group-hover:from-purple-600/50 group-hover:to-blue-500/50 group-hover:text-cyan-300 dark:bg-white/5'>
