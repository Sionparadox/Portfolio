  ...
  return (
    ...
    >
      <div className='flex flex-col items-center justify-center gap-8 text-center'>
        <h1 className='text-3xl font-bold md:text-5xl'>Explore My Space!</h1>
      ...
      {/* <div className='from-primary via-secondary to-primary h-0.5 w-40 rounded-full bg-gradient-to-r' /> */}
