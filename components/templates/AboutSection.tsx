      ...
      <div className='flex flex-col gap-4'>
        <div className='border-secondary flex flex-1 flex-col gap-4 border-r-2 px-4 py-2 text-left leading-relaxed break-keep'>
          ...
          <p>
            ...
            쌓여 높은 사용자 경험을 완성한다고 생각합니다. 사소한 인터랙션 하나,
            최적화 하나에 <StrokeText>집요하게 고민</StrokeText>하며 사용자를
            만족시키기 위해 노력합니다. 이러한 고민의 과정은 저를 프론트엔드
            개발자를 넘어, 시스템 전반을 아우르는 풀스택 엔지니어로 나아가게
            하는 핵심 동력이 됩니다.
          </p>
          <p>
            <b>
            ...
            통해 효율적인 사고방식을 훈련하고 있으며, 이를 실제 코드에 녹여내어{' '}
